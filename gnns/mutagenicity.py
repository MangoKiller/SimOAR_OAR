...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', nargs='?', default=osp.join(osp.dirname(osp.realpath(__file__)), '..', 'data', 'Mutagenicity'), help='data path.')
    ...
    train_dataset = Mutagenicity(root=args.data_path, train=True)
    test_dataset = Mutagenicity(root=args.data_path, train=False)
    ...
    torch.save(model.cpu(), osp.join(args.model_path, 'mutagenicity.pt'))
